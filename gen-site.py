...
SITES = {
    ...
    "impromptune": {"base": "https://impromptune.com", "title": "Impromptune",
                    "pages": [("index.html", "/", 1.0), ("docs/index.html", "/docs/", 0.9), ("docs/quickstart.html", "/docs/quickstart", 0.9),
                              ("docs/programs.html", "/docs/programs", 0.8), ("docs/data.html", "/docs/data", 0.8),
                              ("docs/evaluate.html", "/docs/evaluate", 0.8), ("docs/optimization.html", "/docs/optimization", 0.8),
                              ("docs/steps.html", "/docs/steps", 0.8), ("docs/serving.html", "/docs/serving", 0.8),
